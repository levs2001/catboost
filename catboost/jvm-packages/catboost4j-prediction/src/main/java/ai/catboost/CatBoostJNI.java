...
class CatBoostJNI {
    ...
    final void catBoostModelGetFloatFeatures(
        ...
        CatBoostJNIImpl.checkCall(
            CatBoostJNIImpl.catBoostModelGetFloatFeatures(handle, names, flat_feature_index, feature_index, has_nans, nan_value_treatment));
    }
    ...
    final void catBoostModelPredict(
        ...
        CatBoostJNIImpl.checkCall(
            CatBoostJNIImpl.catBoostModelPredict(handle, numericFeatures, catFeatures, textFeatures, embeddingFeatures, predictions));
    }
    ...
    final void catBoostModelPredict(
        ...
        final @NotNull double[] predictions) throws CatBoostError {
        CatBoostJNIImpl.checkCall(
            CatBoostJNIImpl.catBoostModelPredict(handle, numericFeatures, catFeatureHashes, textFeatures, embeddingFeatures, predictions));
    }
    ...
    final void catBoostModelPredictTransposed(
        final long handle,
        final @NotNull float[][] transposedFeatures,
        final @NotNull double[] predictions
    ) throws CatBoostError {
        CatBoostJNIImpl.checkCall(CatBoostJNIImpl.catBoostModelPredictTransposed(handle, transposedFeatures, predictions));
    }
}
